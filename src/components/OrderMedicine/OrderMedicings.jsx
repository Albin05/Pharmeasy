               ...
               <div className="one">
                  <div className="one_one"> 
                               ...
                               <div>
                                  ...
                                  <select  className ="SelectTag" id="">
                                   <option value=""><h2>Select Pincode</h2></option>
                  ...
                  <div className="two_two">
                        <div className="order">
                            ...
                            <a className="press" href="##">Order Via Prescribed</a>
         ...
         */}
         ...
         <div className="image">
            <div className="image_scroll">
                <img  src="https://consumer-app-images.pharmeasy.in/marketing/comp_50lac.jpg" alt="img one"/>
                <img src="https://consumer-app-images.pharmeasy.in/marketing/comp_india_covered.jpg" alt="img two"/>
                <img src="https://consumer-app-images.pharmeasy.in/marketing/comp_cod.jpg" alt="img three"/>
            </div>
            </div>
            ...
            {/* views_scroll */}
               <div className="views"> 
                  ...
                  <div className="questions">
                      ...
                      <h2 className="que">Online Medicine - Your Online Medical Store in India</h2>
                      <span style={{textAlign: "start"}}>
                          <p className="paragraph">
                      ...
                      <span style={{textAlign: "start"}}>
                          <p className="paragraph">
                          Here are a few reasons that will convince you to give online medicine order through the PharmEasy app -
                          </p>
                          <p className="paragraph">
                               ...
                               Cash on delivery option available <br/>
                                  Attractive offers <br/>
                                    ...
                                    Stringent quality checks <br/>
                                      Garnered the trust of more than 10 million users who have made an online purchase through PharmEasy <br/>
                          </p>
                      </span>
                      ...
                      <span style={{textAlign: "start"}}>
                          <p className="paragraph">
                          PharmEasy is a one-stop-shop for all your healthcare needs. We have 1L+ products for you to choose from. Buy medicines online at affordable prices from the comforts of your home in just a few clicks and get them delivered at your doorstep.
                      ...
                      {/* button box */}
                             <div className="button_box"> 
                               <h2 className="heading"> <span>✅ Is buying medicines online safe?</span></h2>
                               <div className="answers">
                                   ...
                                   PharmEasy is used by 5M+ users across 1.2k+ cities in India incl. Bangalore, Delhi, Mumbai, Kolkata, Hyderabad, Gurgaon, Noida, Pune, etc. for purchasing medicines online.
                             ...
                             <div className="button_box"> 
                               <h2 className="heading"> <span>✅ When will PharmEasy deliver my medicines?</span></h2>
                               <div className="answers">
                                   <span className="answer">
                                   Once you purchase your medicines online with us, you will get it within 24-48* hours. <br/>
                                   *T&C: The delivery time might vary depending on the delivery location.                                 
                                   </span>
                               </div>
                             </div>

                             <div className="button_box"> 
                               <h2 className="heading"><span>✅ Do I get discounts/cashback while ordering medicines online with PharmEasy?</span></h2>
                               <div className="answers">
                                   <span className="answer">
                                   Yes, you can get huge discounts and massive e-wallet cashback on purchasing medicines.                               
                                   </span>
                               </div>
                             </div>

                             <div className="button_box"> 
                               <h2 className="heading"><span>✅ When will I receive my order?</span></h2>
                               <div className="answers">
                                   <span className="answer">
                                   Your order will be delivered as per the 'Estimated Delivery Date' committed at the time of order placement. You can check this by selecting your order from the "My Orders" section. Keep a lookout for our order delivery updates. <br/>
                                    Note: Due to the current COVID-19 crisis, the delivery date may not be as per usual timelines and we request you to bear with us. But rest assured, we are working round the clock to deliver your order as soon as possible.
                                   </span>
                               </div>
                             </div>

                             <div className="button_box"> 
                               <h2 className="heading"><span>✅ What is the shelf life of medicines being provided?</span></h2>
                               <div className="answers">
                                   <span className="answer">
                                   <span>We ensure that the shelf life of the medicines being supplied by our partner retailers is a minimum of 3 months from the date of delivery.</span>
                                   </span>
                               </div>
                             </div>

                             <div className="button_box"> 
                               <h2 className="heading"><span>✅ How do I cancel my order?</span></h2>
                               <div className="answers">
                                   <span className="answer">
                                   <span>You can cancel your order from the ‘Order Details’ screen before it is out for delivery. Simply click on the Account icon at the bottom of the App Homepage &gt; select ‘Orders’ &gt; Select the order which you want to cancel &gt; tap “Cancel”. You can also refuse it at the time of delivery and a refund will be processed to the payment source, if the order amount was paid online.</span>
                                   </span>
                               </div>
                             </div>
                      ...
                      <div className="bottom">
                             <div className="bottom_box">
                                ...
                                <div className="lakh">
                                    <img src="https://pharmeasy.in/_next/image?url=%2Ficons%2FgenuineMedicine.svg&w=64&q=75" alt="1 lakh"/>
                                    <h3>1 Lakh+ Products</h3>
                                    <div className="AppBenefits_benefitDescription__fG4G4">We maintain strict quality controls on all our partner retailers, so that you always get standard quality products.</div>
                                </div>

                                <div className="lakh">
                                    <img src="https://pharmeasy.in/_next/image?url=%2Ficons%2FsecurePayment.svg&w=64&q=75" alt="1 lakh"/>
                                    <h3>Secure Payment</h3>
                                    <div className="AppBenefits_benefitDescription__fG4G4">100% secure and trusted payment protection</div>
                                </div>

                                <div className="lakh">
                                    <img src="https://pharmeasy.in/_next/image?url=%2Ficons%2FeasyReturn.svg&w=64&q=75" alt="1 lakh"/>
                                    <h3>Easy Return</h3>
                                    <div className="AppBenefits_benefitDescription__fG4G4">We have a new and dynamic return window policy for medicines and healthcare items. Refer FAQs section for more details.</div>
                                </div>
