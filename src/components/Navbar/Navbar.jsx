              ...
              <div className="Navbar_main_container">
               ...
               {/* -------------------rightDiv----------------------------- */}
                    <div className="Navbar_main_seconDiv_Right">
                      <ul>
                      <img className="Navbarcart"  src="https://assets.pharmeasy.in/web-assets/dist/275c07e1.svg" alt="" /> 
                        <li>
                        <a href="/">Offers</a>
                        </li>
                        <img className="Navbarcart"   src="https://assets.pharmeasy.in/web-assets/dist/5eb42971.svg" alt="" />
                        <li>
                          <a href="/">Login/Signup</a>
                        </li>
                        <img  className="Navbarcart"  src="https://assets.pharmeasy.in/web-assets/dist/21b0b5ba.svg" alt="" />
                        <li>
                          <a href="/">Cart</a>
                        </li>
